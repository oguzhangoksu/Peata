...
import { ReactComponent as AISVG } from "../../Assets/artificial-intelligence-ai-icon.svg"; // Import your SVG file using ReactComponent
import Dropdown from 'react-bootstrap/Dropdown';
import DropdownButton from 'react-bootstrap/DropdownButton';

function NewAdoption(props) {
  ...
  const handleSubmit=(e)=>{
    ...
    if(correctData()){
      axios.post(`http://localhost:${props.port}/saveAdoption`, formData, {
        headers: {
          'Authorization': `${token}`
        }
      }).then(response => {
        ...
        alert("Adoption Add is saved successfully");
      }).catch(error => {
        console.error(error);
      });   
    }
  ...
  const handleClickAI = async() => {
    ...
    axios.post(`http://localhost:${props.port}/AIPredict`, {imageLink: imageURL}, {
      ...
      console.log("Result",response.data);//Prediction result
  ...
  return (
    <section >
      ...
      <Card className="shadow-sm" style={{textAlign:"center",placeItems:"center"}}>
          <h5 className="mb-3">New Adoption</h5>
          ...
          <Card.Body style={{width:"50%"}}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <InputGroup size="md" className="mb-1"  >
                    ...
                    <DropdownButton id="dropdown-basic-button" title="Select City" className="custom-dropdown-button" >
                ...
                <InputGroup size="md" className="mb-3">
                  ...
                  />
                    ...
                    <Button type="submit" variant="primary">Save New Adoption Add</Button>
